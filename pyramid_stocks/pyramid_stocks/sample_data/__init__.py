MOCK_DATA = [
    ...
    },
    {
        ...
        "description": "Alphabet Inc., through its subsidiaries, provides online advertising services in the United States and internationally. The company offers performance and brand advertising services. It operates through Google and Other Bets segments. The Google segment includes principal Internet products, such as Ads, Android, Chrome, Commerce, Google Cloud, Google Maps, Google Play, Hardware, Search, and YouTube, as well as technical infrastructure and newer efforts, including Virtual Reality. This segment also offers digital content, enterprise cloud services, and hardware products, as well as other miscellaneous products and services. The Other Bets segment includes businesses, such as Access, Calico, CapitalG, GV, Nest, Verily, Waymo, and X, as well as fiber Internet and Television services. Alphabet Inc. was founded in 1998 and is headquartered in Mountain View, California.",
        "CEO": "Sergey Brin",
        "issueType": "cs",
        "sector": "Technology"
    },
    ...
    },
    {
        ...
        "exchange": "New York Stock Exchange",
        "industry": "Farm & Construction",
        "website": "www.caterpillar.com",
        "description": "Moving crap that Deeres can't.",
        "CEO": "James Umpleby",
        "issueType": "cs",
        "sector": "Industrial Goods"
    },
